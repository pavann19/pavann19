...
|---|---|---|
| **[Gatekeeper](https://github.com/pavann19/Gatekeeper-AI-Infrastructure-and-Governance-Gateway)**<br>![CI](https://github.com/pavann19/Gatekeeper-AI-Infrastructure-and-Governance-Gateway/actions/workflows/ci.yml/badge.svg) | Fail-closed AI security gateway that screens prompts for injection and PII before they reach an LLM (multi-detector fusion, German-language calibration) | py-spy profiling and a benchmark methodology flaw I caught myself · before/after results in `docs/perf/` · Trivy + SBOM in CI |
